...
if __name__ == "__main__":
    ...
    if args.mode == "google_reviews":
        reviews_list = crawl_google_reviews(search_query=args.search_query, num_reviews=args.num_reviews)
    elif args.mode == "tripadvisor":
        reviews_list = crawl_tripadvisor_reviews(search_query=args.search_query, num_reviews=args.num_reviews)